...
<\body>
  ...
  <\enumerate>
    ...
    usage, pour extraire les différentes données. Représenter la
    consommation, la production de nucléaire, d'éolien et de PV sur
    différentes periodes: un jour, une semaine, un mois et un an, à l'aide de
  ...
  ça parait compliqué à moins d'avoir d'autres données ? ou alors leur faire
  dire simplement qu'il faudrait un espace d'échange de la taille d'une demi
  planète pour que ça contionne ?\ 
...
<\auxiliary>
  <\collection>
    <\associate|toc>
      ...
      <vspace*|1fn><with|font-series|<quote|bold>|math-font-series|<quote|bold>|2<space|2spc>Données>
      ...
      <vspace*|1fn><with|font-series|<quote|bold>|math-font-series|<quote|bold>|4<space|2spc>Aggrégation
      ?> <datoms|<macro|x|<repeat|<arg|x>|<with|font-series|medium|<with|font-size|1|<space|0.2fn>.<space|0.2fn>>>>>|<htab|5mm>>
